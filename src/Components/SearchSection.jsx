...
function SearchSection() {
  ...
  return (
    // <div className="flex flex-wrap items-center justify-around bg-sky-300 p-10" >
    // <img src={search} alt="" className='h-96 shadow-2xl '/>
    // <div className='flex flex-col w-2/5 sm:w-2/5 md:justify-center sm:text-center justify-center gap-11'>
    // <h1 className='text-6xl font-bold w-4/5 text-white '>Search your college mates!</h1>
